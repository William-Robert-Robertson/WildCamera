...
Another important thing to me Is the product design of the housing to easily attach it at the bottom/top and back using threads/straps, tree hooks etc. or even camera rig plates to ensure a consistent angle/view.

As time lapse series offer additional important information (phenology etc), I would like to choose a combined optional mode using PIR-trigger and time lapse.
